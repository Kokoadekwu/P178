...
label_quantity = Label(root, text="Enter Quantity ",bg="orange",  font=("Bahnschrift Light",12))
...
#Total Cost Label
label_show_amount = Label(root, text="Enter Quantity ",bg="orange",  font=("Bahnschrift Light",12))
label_show_amount.place(relx=0.95,rely=0.7, anchor= E)
#Quantity Label
label_show_quantity = Label(root, text="Enter Quantity ",bg="orange",  font=("Bahnschrift Light",12))
...
btn = Button(root, text="TOTAL", bg="red3", fg="white", padx=10, pady=1,
font=("Arial",11, "bold"), relief=FLAT, command=orderJuice)
